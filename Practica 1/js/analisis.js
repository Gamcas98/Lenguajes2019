...
function comprobarTipo(texto){//nos devuelve un string indicando el tipo de token
    ...
    if((textoEntrada.value.charCodeAt(0)>=97 && textoEntrada.value.charCodeAt(0)<=122) || (textoEntrada.value.charCodeAt(0)>=65 && textoEntrada.value.charCodeAt(0)<=90) ){
    ...
    }else{//si no cumple con empezar con letra numero o simbolo, nos envia a un estado de error
        return("error");
    }
